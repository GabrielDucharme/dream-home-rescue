...
export const metadata: Metadata = generateMeta({
  ...
  description: 'Découvrez les histoires touchantes de nos chiens adoptés et leurs nouvelles familles.',
})
    ...
    <div className="container py-12">
      <div className="flex flex-col items-center text-center mb-12">
        ...
        <p className="text-xl max-w-3xl">
          Chaque chien mérite une maison aimante. Voici les histoires touchantes des chiens qui ont trouvé leur famille pour toujours grâce à Dream Home Rescue.
        </p>
      </div>

      {stories.length === 0 ? (
        <div className="text-center p-12 bg-[#EDEBE0] rounded-lg">
          <h2 className="text-2xl font-fraunces font-semibold mb-4">Aucune histoire disponible pour le moment</h2>
          <p className="mb-6">Revenez bientôt pour découvrir les histoires touchantes de nos adoptions!</p>
          <Button asChild>
            <Link href="/dogs?status=available">
              Voir les chiens disponibles pour l'adoption
            </Link>
          </Button>
        </div>
      ) : (
            ...
            >
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 p-4 text-white">
                  ...
                  <h2 className="text-xl font-fraunces font-bold">{story.dog?.name}</h2>
                </div>
              </div>
              <div className="p-5">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-500">Adopté par {story.family}</span>
                  <span className="text-primary font-medium group-hover:underline">Lire l'histoire</span>
                </div>
              </div>
            </Link>
          ))}
